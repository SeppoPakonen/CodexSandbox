/*
         ...
         tested on other platforms. E-mail: sdts@usgs.gov
...
read_catd_mod ()
{
  char  mod_name[5], mod_type[30], mod_file[30];
...
/* Init space      4-17-97  */
  mod_name[0] = '\0';
  mod_type[0] = '\0';
  mod_extr[0] = 'N';   /* default value if not present */
  mod_extr[1] = '\0';
  mod_file[0] = '\0';
