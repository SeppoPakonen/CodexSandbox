...
void CreateNodeArray(int size, bool hackUseFrontEndHeap)
{
	...
	if (hackUseFrontEndHeap)
		MemManagerHandlePushContext(MemManagerHandleFrontEndHeap()); // Use the temporary heap.
	else
		MemManagerHandlePushContext(MemManagerHandleTopDownHeap()); // Use the temporary heap.
