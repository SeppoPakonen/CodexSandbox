...
/*                                                                */
/******************************************************************/
inline Mth::Vector get_bone_scale( int bone_index )
{
...
/*                                                                */
/******************************************************************/
inline Mth::Vector get_bone_pos( int bone_index )
{
...
////
////			if ( MemManagerHandleGetContextAllocator() == MemManagerHandleSkaterGeomHeap(0) )
////			{
////				heap = NsARAM::SKATER0;
////			}
////			if ( MemManagerHandleGetContextAllocator() == MemManagerHandleSkaterGeomHeap(1) )
////			{
////				heap = NsARAM::SKATER1;
////			}
////
////			//OSReport( "Allocating %d ARAM bytes %s\n", dbytes + sbytes, MemManagerHandleGetContextName() );
...
//	p_temp_uv_remap = m_num_uv_sets ? new (MemManagerHandleTopDownHeap()) uint16[m_num_vertex*m_num_uv_sets] : NULL;
//	p_temp_col_remap = mp_colBuffer ? new (MemManagerHandleTopDownHeap()) uint16[m_num_vertex] : NULL;
//
