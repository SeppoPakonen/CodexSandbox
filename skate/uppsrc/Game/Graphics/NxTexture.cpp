...
//	NumTextures				+= num_textures;
	...
	NxNgc::sTexture ** p_tex = new (MemManagerHandleTopDownHeap()) NxNgc::sTexture *[num_textures];
	unsigned short * p_resolvem = new (MemManagerHandleTopDownHeap()) unsigned short[num_textures];
	unsigned short * p_resolvec = new (MemManagerHandleTopDownHeap()) unsigned short[num_textures];
	int num_resolve = 0;
	...
	for( int t = 0; t < num_textures; ++t )
	{
		...
		for( uint32 mip_level = 0; mip_level < p_texture->Levels; ++mip_level )
		{
			...
			p8[mip_level] = new (MemManagerHandleTopDownHeap()) uint8[texture_level_data_size];
