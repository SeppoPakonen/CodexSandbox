...
CLightGroup::CLightGroup()
{
	...
	for(int i=0;i<2;i++) m_light_vector[i] = s_default_lights.m_light_vector[i];

	for(int i=0;i<2;i++) m_diffuse_base_color[i] = s_default_lights.m_diffuse_base_color[i];
	for(int i=0;i<2;i++) m_diffuse_mod_color[i] = s_default_lights.m_diffuse_base_color[i];
