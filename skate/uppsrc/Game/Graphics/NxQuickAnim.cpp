...
inline void interpolate_q_frame(Mth::Quat* p_out, Gfx::CAnimQKey* p_in1, Gfx::CAnimQKey* p_in2, float alpha, bool isHiRes)
{
	...
	Mth::Quat	qIn1;
	Nx::get_rotation_from_key( p_in1, &qIn1, isHiRes );
	...
	Mth::Quat   qIn2;
	Nx::get_rotation_from_key( p_in2, &qIn2, isHiRes );
...
inline void interpolate_t_frame(Mth::Vector* p_out, Gfx::CAnimTKey* p_in1, Gfx::CAnimTKey* p_in2, float alpha, bool isHiRes)
{
    ...
    Mth::Vector   tIn1;
	Nx::get_translation_from_key( p_in1, &tIn1, isHiRes );
	...
	Mth::Vector   tIn2;
	Nx::get_translation_from_key( p_in2, &tIn2, isHiRes );
