...
inline u16 hwPadGetButton(u32 i)
    { return hwPad[i].pst.button; }

inline u16 hwPadGetButtonUp(u32 i)
    { return hwPad[i].buttonUp; }

inline u16 hwPadGetButtonDown(u32 i)
    { return hwPad[i].buttonDown; }

inline u16 hwPadGetDirs(u32 i)
    { return hwPad[i].dirs; }

inline u16 hwPadGetDirsNew(u32 i)
    { return hwPad[i].dirsNew; }

inline u16 hwPadGetDirsReleased(u32 i)
    { return hwPad[i].dirsReleased; }

inline s8  hwPadGetStickX(u32 i)
    { return hwPad[i].pst.stickX; }

inline s8  hwPadGetStickY(u32 i)
    { return hwPad[i].pst.stickY; }

inline s8  hwPadGetSubStickX(u32 i)
    { return hwPad[i].pst.substickX; }

inline s8  hwPadGetSubStickY(u32 i)
    { return hwPad[i].pst.substickY; }

inline u8  hwPadGetTriggerL(u32 i)
    { return hwPad[i].pst.triggerLeft; }

inline u8  hwPadGetTriggerR(u32 i)
    { return hwPad[i].pst.triggerRight; }

inline u8  hwPadGetAnalogA(u32 i)
    { return hwPad[i].pst.analogA; }

inline u8  hwPadGetAnalogB(u32 i)
    { return hwPad[i].pst.analogB; }

inline s8  hwPadGetErr(u32 i)
