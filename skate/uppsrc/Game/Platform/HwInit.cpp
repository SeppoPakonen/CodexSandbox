...
static void __hwInitMem( void )
{
    ...
    hwFrameBuffer1 = (void*)OSRoundUp32B((size_t)arenaLo);
    hwFrameBuffer2 = (void*)OSRoundUp32B((size_t)hwFrameBuffer1 + fbSize);
    hwCurrentBuffer = hwFrameBuffer2;

    arenaLo = (void*)OSRoundUp32B((size_t)hwFrameBuffer2 + fbSize);
