...
void 		CRecordTable::ReadFromStructure(Script::CStruct *pIn)
{
	...
	if (m_numRecords!=(size_t)pArray->GetSize())
	{
...
void 		CRecordTable::WriteIntoStructure(Script::CStruct *pIn)
{
	...
	pIn->AddComponent(Script::GenerateCRC("RecordTable"),ESYMBOLTYPE_ARRAY,(size_t)pArray);
}
...
void		CLevelRecords::WriteIntoStructure(Script::CStruct *pIn)
{
	...
	pIn->AddComponent(Script::GenerateCRC("HighScores"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);

	pStruct=new Script::CStruct;
   	Dbg_MsgAssert(mp_bestCombos,("NULL mp_bestCombos"));
	mp_bestCombos->WriteIntoStructure(pStruct);
	pIn->AddComponent(Script::GenerateCRC("BestCombos"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);

	pStruct=new Script::CStruct;
   	Dbg_MsgAssert(mp_longestCombo,("NULL mp_longestCombo"));
	mp_longestCombo->WriteIntoStructure(pStruct);
	pIn->AddComponent(Script::GenerateCRC("LongestCombo"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);

	pStruct=new Script::CStruct;
   	Dbg_MsgAssert(mp_longestGrind,("NULL mp_longestGrind"));
	mp_longestGrind->WriteIntoStructure(pStruct);
	pIn->AddComponent(Script::GenerateCRC("LongestGrind"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);

	pStruct=new Script::CStruct;
   	Dbg_MsgAssert(mp_longestLipTrick,("NULL mp_longestLipTrick"));
	mp_longestLipTrick->WriteIntoStructure(pStruct);
	pIn->AddComponent(Script::GenerateCRC("LongestLipTrick"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);

	pStruct=new Script::CStruct;
	Dbg_MsgAssert(mp_longestManual,("NULL mp_longestManual"));
	mp_longestManual->WriteIntoStructure(pStruct);
	pIn->AddComponent(Script::GenerateCRC("LongestManual"),ESYMBOLTYPE_STRUCTUREPOINTER,(size_t)pStruct);
}
...
void 		CGameRecords::ReadFromStructure(Script::CStruct *pIn)
{
	...
	if (m_numLevels!=(size_t)pArray->GetSize())
	{
...
void 		CGameRecords::WriteIntoStructure(Script::CStruct *pIn)
{
	...
	pIn->AddComponent(Script::GenerateCRC("GameRecords"),ESYMBOLTYPE_ARRAY,(size_t)pArray);
