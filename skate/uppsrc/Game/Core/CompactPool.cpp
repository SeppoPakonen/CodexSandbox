...
void CCompactPool::Free(void *pFreeItem)
{
	...
	int pool_item = ((size_t) ((uint8 *) pFreeItem - mp_buffer)) / m_itemSize;
...
/*
	...
	if (p_free_next)
	{
		int pool_item = ((size_t) ((uint8 *) p_free_next - mp_buffer)) / m_itemSize;
