...
//	Dbg_SetPlacementNew( false );
	void * rv = MemManagerHandleNew( size, true );
...
{
	void*		p_ret = MemManagerHandleNew( size );
...
{
	void*		p_ret = MemManagerHandleNew( size, assert_on_fail );
...
{
	void*	p_ret = MemManagerHandleNew( size, assert_on_fail, pAlloc );
