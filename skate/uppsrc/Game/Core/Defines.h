...
#define nAligned(P) 		( !( (size_t) (P) & (~PTR_ALIGNMASK) ) )
#define nAlignDown(P) 		(void*)( (size_t) (P) & PTR_ALIGNMASK )
#define nAlignUp(P)			(void*)( ( (size_t) (P) + ( 1 << __CPU_WORD_BALIGN__ ) - 1 ) & PTR_ALIGNMASK )
#define nAlignedBy(P,A) 	( !( (size_t) (P) & ( ~(vUINT_MAX << (A) ) ) ) )
#define nAlignDownBy(P,A) 	(void*)( (size_t) (P) & (vUINT_MAX << (A) ) )
#define nAlignUpBy(P,A)		(void*)( ( (size_t) (P) + ( 1 << (A) ) - 1 ) & ( vUINT_MAX <<( A ) ) )
#define nStorage(X)			nAlignUp ( (X) + 1 )

/****************************************************************************/

#define	nAddPointer(P,X)		(void*) ( (size_t) (P) + (size_t) (X) )
#define	nSubPointer(P,X)		(void*) ( (size_t) (P) - (size_t) (X) )
...
{
	return MemManagerHandleNew( size, true );
}
/******************************************************************/
/*                                                                */
/*                                                                */
...
inline void* 	operator new( size_t size, bool assert_on_fail )
{
	return MemManagerHandleNew( size, assert_on_fail );
}
...
{
	return MemManagerHandleNew( size, assert_on_fail, pAlloc );
}
/******************************************************************/
/*                                                                */
/*                                                                */
...
inline void* 	__trash_new( size_t size, void* pLocation )
{
	return pLocation;
}
...
inline void* 	__trash_new_arr( size_t size, void* pLocation )
{
	return pLocation;
}
