...
CScreenElementPtr CScreenElementManager::CreateElement(uint32 type, uint32 id, Script::CScriptStructure *pProps)
{
	...
	if (pProps->GetChecksum("heap", &heap_crc))
	{
		switch ( heap_crc )
		{
			...
			case 0x9f7b7843:		// network
				MemManagerHandlePushContext(MemManagerHandleNetworkHeap());
				switched = true;
				break;
			case 0x03c84a59:		// profiler
				MemManagerHandlePushContext(MemManagerHandleProfilerHeap());
				switched = true;
				break;
			case 0x935ab858:		// debug
				MemManagerHandlePushContext(MemManagerHandleDebugHeap());
				switched = true;
				break;
			case 0x5b8ab877:		// skater
				pProps->GetInteger("heapnum", &heap_num);
				MemManagerHandlePushContext(MemManagerHandleSkaterHeap(heap_num));
				switched = true;
				break;
			...
			case 0x39fb63cc:		// skatergeom
				pProps->GetInteger("heapnum", &heap_num);
				MemManagerHandlePushContext(MemManagerHandleSkaterGeomHeap(heap_num));
				switched = true;
				break;
			case 0xe3f81b18:		// internettopdown
				MemManagerHandlePushContext(MemManagerHandleInternetTopDownHeap());
				switched = true;
				break;
			case 0xbaa81175:		// internetbottomup
				MemManagerHandlePushContext(MemManagerHandleInternetBottomUpHeap());
				switched = true;
				break;
			case 0x1ca1ff20:		// default (ie don't change context).
				break;
			default:	// Default = frontend
				MemManagerHandlePushContext(MemManagerHandleFrontEndHeap());
				switched = true;
				break;
		}
	}
	...
	if ( switched ) MemManagerHandlePopContext();
