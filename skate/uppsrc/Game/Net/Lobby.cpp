...
void 	LobbyMan::s_get_room_keys_callback( PEER peer, bool success, int roomType,
...
void	LobbyMan::s_enum_players_callback( PEER peer, bool success, int roomType, int index, const char * nick,  // The nick of the player.
...
bool	LobbyMan::ScriptLobbyConnect(Script::CScriptStructure *pParams, Script::CScript *pScript)
{
	...
	net_thread_data.m_pEntry = (void*)&s_threaded_peer_connect;
