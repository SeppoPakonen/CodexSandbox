...
enum
{
	...
	HOSTED_MODE_KEY,
	RANKED_KEY,
	RATING__KEY, PLAYER__KEY, PING__KEY,
};
...
private:
	...
	static	void	s_enum_players_callback( PEER peer, bool success, int roomType, int index, const char * nick,  // The nick of the player.
	...
	static	void	s_join_room_callback( PEER peer, PEERBool success, PEERJoinResult result, RoomType roomType,
										void * param );
	static	void 	s_get_room_keys_callback( PEER peer, bool success, int roomType,
