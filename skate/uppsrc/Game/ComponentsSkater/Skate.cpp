...
int				Skate::GetNextUnusedSkaterHeapIndex( bool for_local_skater )
{
	...
	Mem::Heap *skater_heap = MemManagerHandleSkaterHeap(heap_index);
	...
	Mem::Heap *geom_heap = MemManagerHandleSkaterGeomHeap(heap_index);
...
// as they are referenced by the id of the skater.
					MemManagerHandlePushContext(MemManagerHandleSkaterHeap(skater->GetHeapIndex()));
...
////////////////////////////////////////////////////////////////////////////////////
	...
	MemManagerHandlePushContext(MemManagerHandleSkaterHeap(heap_index));
...
void Skate::LaunchGame()
{
	...
	if( !gamenet_man->GetLocalPlayer())
	{
		...
		{
			MemManagerHandleInitSkaterHeaps(GetGameMode()->GetMaximumNumberOfPlayers());
		}
...
bool ScriptInitSkaterHeaps(Script::CStruct *pParams, Script::CScript *pScript)
{
	...
	if( num_skater_heaps_required > NUM_PERM_SKATER_HEAPS )
	{
		...
		MemManagerHandleInitSkaterHeaps(num_skater_heaps_required);
	}
