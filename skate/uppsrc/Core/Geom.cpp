...
double Triangulate::Area(const Vector<Pointf> &contour) {
...
bool Triangulate::Snip(const Vector<Pointf> &contour,int u,int v,int w,int n,int *V) {
	int p;
...
bool Triangulate::Process(const Vector<Pointf> &contour, Vector<Trianglef> &result) {
