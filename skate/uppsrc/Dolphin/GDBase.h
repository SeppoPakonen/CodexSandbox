/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/include/dolphin/gd/GDBase.h $
...
static inline void *GDGetGDLObjStart(GDLObj *dl);
static inline u32   GDGetGDLObjLength(GDLObj *dl);
static inline void *GDGetGDLObjPointer(GDLObj *dl);
static inline u32   GDGetGDLObjOffset(GDLObj *dl);  // for convenience
    
// Manipulate "current" GDL object.
static inline void    GDSetCurrent(GDLObj *dl);
static inline GDLObj *GDGetCurrent();
static inline GXBool  GDIsCurrent(GDLObj *dl);
...
static inline u32 GDGetGDLObjOffset(GDLObj *dl)
{
