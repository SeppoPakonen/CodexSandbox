/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/include/dolphin/mtx/mtx44ext.h $
...
void    C_MTX44RotAxisRad       ( Mtx44 m, VecPtr axis, f32 rad);
...
void    PSMTX44RotAxisRad       ( Mtx44 m, VecPtr axis, f32 rad);
#endif
 ...
 *---------------------------------------------------------------------------*/
// C version
void    C_MTX44MultVec          ( Mtx44 m, VecPtr src, VecPtr dst );
void    C_MTX44MultVecArray     ( Mtx44 m, VecPtr srcBase, VecPtr dstBase, u32 count );
void    C_MTX44MultVecSR        ( Mtx44 m, VecPtr src, VecPtr dst );
void    C_MTX44MultVecArraySR   ( Mtx44 m, VecPtr srcBase, VecPtr dstBase, u32 count );

// PS assembler version
#ifdef GEKKO
void    PSMTX44MultVec          ( Mtx44 m, VecPtr src, VecPtr dst );
void    PSMTX44MultVecArray     ( Mtx44 m, VecPtr srcBase, VecPtr dstBase, u32 count );
void    PSMTX44MultVecSR        ( Mtx44 m, VecPtr src, VecPtr dst );
void    PSMTX44MultVecArraySR   ( Mtx44 m, VecPtr srcBase, VecPtr dstBase, u32 count );
#endif
