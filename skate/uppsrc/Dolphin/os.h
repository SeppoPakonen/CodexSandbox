...
#define OSRoundUp32B(x)       (((size_t)(x) + 32 - 1) & ~(32 - 1))
#define OSRoundDown32B(x)     (((size_t)(x)) & ~(32 - 1))
...
//#define PANIC(msg) ASSERT_(false, msg) //OSHalt(msg)
...
#include "OSAlloc.h"     // Memory allocation routines and defines
#include "OSAlarm.h"     // Alarm routines and defines
#include "OSCache.h"     // Cache operation APIs
#include "OSContext.h"   // Context structures and defines
#include "OSError.h"     // Error handler routines and defines
#include "OSException.h" // Exception handling routines and defines
#include "OSExpansion.h" // Expansion interface APIs
#include "OSFastCast.h"  // Fast float/int conversion
#include "OSFont.h"      // ROM font routines and defines
#include "OSInterrupt.h" // Interrupt handling routines and defines
#include "OSMessage.h"   // Message routines and defines
#include "OSModule.h"    // Relocatable module routines and defines
#include "OSMutex.h"     // Mutex routines and defines
#include "OSResetSW.h"   // Reset switch APIs
#include "OSSerial.h"    // Serial interface APIs
#include "OSSemaphore.h" // Semaphore routines and defines
#include "OSThread.h"    // Thread routines and defines
#include "OSReset.h"     // Reset APIs
