/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/include/dolphin/gd/GDTransform.h $
...
void GDLoadPosMtxImm ( f32 mtx[3][4], u32 id );
void GDLoadPosMtxIndx ( u16 mtx_indx, u32 id );
void GDLoadNrmMtxImm ( f32 mtx[3][4], u32 id );
void GDLoadNrmMtxImm3x3 ( f32 mtx[3][3], u32 id );
void GDLoadNrmMtxIndx3x3 ( u16 mtx_indx, u32 id );
void GDLoadTexMtxImm ( f32 mtx[][4], u32 id, GXTexMtxType type );
