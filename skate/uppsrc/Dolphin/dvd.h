/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/include/dolphin/dvd.h $
...
#if defined flagWIN32 || defined flagPOSIX
	FILE * file;
#endif
...
#define DVDGetFileInfoStatus(fileinfo)                          \
                         DVDGetCommandBlockStatus((DVDCommandBlock*)fileinfo)
...
/*---------------------------------------------------------------------------*
  ...
  Returns:      None
 *---------------------------------------------------------------------------*/
#define DVDRewindDir(dir)           ((dir)->location = (dir)->entryNum + 1)
