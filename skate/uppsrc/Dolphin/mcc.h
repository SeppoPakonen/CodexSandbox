/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/include/dolphin/mcc.h $
...
// HEADER INCLUDE
// ================
#ifdef flagWIN32//host incluide here
#   include <windows.h>
...
BOOL WINAPI MCCWrite           ( MCCChannel chID, u32 offset, void *data, s32 size, MCCAsync async );
...
BOOL WINAPI MCCStreamWrite	( MCCChannel chID, void *data, u32 dataBlockSize );
