...
uint32 __cntlzw(uint32 d); //u32 NumLeadingZeros(u32 d) from DOLPHIN\build\libraries\gx\src\GXTexture.c(257)
...
#define KEY_STRING "Software\\Microsoft\\Windows\\CurrentVersion\\App Paths\\skaterz.Exe"
