#ifndef _Core_Callback_h_
#define _Core_Callback_h_
...
public:
	...
	virtual void Execute(const A0& a0) { (*obj.*fn)(a0); }
};
...
public:
	...
	virtual void Execute() { (*obj.*fn)(a0); }
};
...
public:
	...
	virtual void Execute(const A0& a0) { (*obj.*fn)(a0, a1); }
};
...
public:
	...
	virtual void Execute(const A0& a0, const A1& a1) { (*obj.*fn)(a0, a1); }
};
...
public:
	...
	virtual void Execute() { cb->Execute(); }
};
...
public:
	...
	virtual void Execute(const A0& a0) { cb->Execute(a0); }
};
