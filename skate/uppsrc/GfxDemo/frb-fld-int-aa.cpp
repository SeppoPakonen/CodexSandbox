/*---------------------------------------------------------------------------*
  ...
  $Log: /Dolphin/build/demos/gxdemo/src/Framebuffer/frb-fld-int-aa.c $
...
static u8  inappropriateFilter[7] = {
    4, 11, 11, 12, 11, 11, 4
};
...
static void AnimTick( void )
{
    ...
    if (aaMode != oldaaMode)
    {
        switch(aaMode) 
        {
          ...
          case 2:  OSReport("AA off, inappropriate deflicker on\n"); break;
...
{
    OSReport("\n\n*************************************************\n");
    OSReport("frb-fld-int-aa: demonstrate interlaced field antialiasing\n");
