...
// We'll define all episodes for the U++ version
#define WITH_KEEN4
#define WITH_KEEN5
#define WITH_KEEN6
...
// Enable this to prefer XDG paths for the user directory to the XDG path above.
// This is disabled by default, in which case XDG paths are used as a fallback.
// SDL 2.0.1 is required.
