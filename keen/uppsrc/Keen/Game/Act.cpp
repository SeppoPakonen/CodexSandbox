...
static STR_Table* ck_functionTable;
...
static STR_Table *ck_varTable;
static ID_MM_Arena *ck_varArena;
static CK_action *ck_actionData;
static int ck_actionsUsed;
static bool ck_varsLocked = false;
...
void CK_VAR_SetIntArray(const char *name, intptr_t *array, size_t arrayLen)
{
	...
	std::memcpy(realArray, array, arrayLen * sizeof(intptr_t));
#ifdef CK_VAR_TYPECHECK
	CK_VAR_Variable *var = (CK_VAR_Variable *)MM_ArenaAlloc(ck_varArena, sizeof(*var));
...
void CK_VAR_SetStringArray(const char *name, const char **array, size_t arrayLen)
{
	...
	std::memcpy(realArray, array, arrayLen * sizeof(const char *));
#ifdef CK_VAR_TYPECHECK
	CK_VAR_Variable *var = (CK_VAR_Variable *)MM_ArenaAlloc(ck_varArena, sizeof(*var));
